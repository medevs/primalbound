  ...
  return (
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <section className="bg-blue-500 dark:bg-gray-800 text-white py-20">
          <div className="container mx-auto text-center">
            ...
            <a
              href="/blog"
              className="py-2 px-6 rounded-full font-semibold hover:bg-blue-100 dark:hover:bg-gray-100 transition duration-300 bg-white dark:bg-gray-800 text-blue-500 dark:text-blue-500"
            >
              Explore the Blog
            </a>
          </div>
